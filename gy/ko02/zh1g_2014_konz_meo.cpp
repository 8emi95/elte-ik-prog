...
Sorban egymás után rendeltek fagyit. Egy fájlba idõrendben feljegyeztük, hogy melyik gyerek hány gombóc fagyit evett.
A gyerekeket a keresztnevükkel azonosítjuk, így nincs két azonos nevû gyerek. Senki se evett negatív számú gombócot... :)
Hogy hívják azt a kölköt, aki a legtöbb, sorban õt megelõzõ osztálytársánál több gombóc fagyit fogyasztott el?
...
bool mindenkiegyszer(const vector<Fagyi> &t)   //for alakban
{
	bool l = true;
...
bool egyszer(const vector<Fagyi> &t, size_t i)  //while alakban
{
	bool l = true;
	size_t j = 0;
